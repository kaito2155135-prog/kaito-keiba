...
st.write("列名自動変換・完全安定版！過去5年分データ合体＆ブリンカー対応や！🔥")
...
if len(dfs) > 0:
    ...
    for col in df_m_auto.columns:
        ...
        elif c_str in ['開催', '場所', '競馬場']:
            rename_cols[col] = 'place'
        elif c_str in ['芝・ダート', 'トラック']:
            rename_cols[col] = 'track'
        elif c_str in ['馬場', '馬場状態']:
