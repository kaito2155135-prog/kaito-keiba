...
st.write("ファイル読み込み完全安定版！過去5年分データ合体＆ブリンカー対応や！🔥")
...
with tab1:
    ...
    if len(df_m_auto) > 0:
        ...
        st.warning("⚠️ マスターデータが見つかりません。ファイル名を確認してね！")
